...
use bitvm::bn254::utils::fq12_push;
use bitvm::{
    bn254::{
...
impl Verifier {
    ...
    pub fn verify_proof_with_prepared_inputs(
        ...
        let ell_coeffsss: Vec<(ark_bn254::Fq2, ark_bn254::Fq2, ark_bn254::Fq2)> = beta_prepared
            ...
            .collect();
        let beta_prepared: bitvm::bn254::ell_coeffs::G2Prepared =
            bitvm::bn254::ell_coeffs::G2Prepared {
        ...
        let ell_coeffsss: Vec<(ark_bn254::Fq2, ark_bn254::Fq2, ark_bn254::Fq2)> = pvk
            ...
            .collect();
        let gamma_g2_neg_pc: bitvm::bn254::ell_coeffs::G2Prepared =
            bitvm::bn254::ell_coeffs::G2Prepared {
                ell_coeffs: ell_coeffsss,
            };
        ...
        let ell_coeffsss: Vec<(ark_bn254::Fq2, ark_bn254::Fq2, ark_bn254::Fq2)> = pvk
            ...
            .collect();
        let delta_g2_neg_pc: bitvm::bn254::ell_coeffs::G2Prepared =
            bitvm::bn254::ell_coeffs::G2Prepared {
                ell_coeffs: ell_coeffsss,
            };
        ...
        // TODO: Seperate this into scripts"
        script! {
